export function createRunReplayRuntime({
  COLORS,
  createInitialState,
  ...
  function sanitizeRunActions(actions) {
  ...
  function replayRun(seed, rawActions, options = PRODUCTION_RUN_OPTIONS) {
  ...
  function getReplayResultSummary(stateLike) {
  ...
  function getReplayCollectionTiles(stateLike) {
    const out = {};
