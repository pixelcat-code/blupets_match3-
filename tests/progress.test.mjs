...
test("capsulesForScore uses the agreed non-cumulative score thresholds", () => {
  assert.equal(capsulesForScore(4999), 0);
  assert.equal(capsulesForScore(5000), 1);
  assert.equal(capsulesForScore(19999), 2);
  assert.equal(capsulesForScore(20000), 3);
  assert.equal(capsulesForScore(35000), 4);
  assert.equal(capsulesForScore(50000), 5);
  assert.equal(capsulesForScore(75000), 7);
  assert.equal(capsulesForScore(100000), 10);
});
